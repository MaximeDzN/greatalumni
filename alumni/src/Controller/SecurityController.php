...
class SecurityController extends AbstractController
{
    ...
    public function signup(EntityManagerInterface $manager, Request $request, UserPasswordEncoderInterface $encoder, \Swift_Mailer $mailer, TokenGeneratorInterface $tokenGenerator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // On génère l'URL pour compléter l'Inscription de mot de passe
            $url = $this->generateUrl('app_full_infos', ['token' => $token], UrlGeneratorInterface::ABSOLUTE_URL);
        ...
        ;
            ...
            $this->addFlash('message', 'E-mail d\'inscription envoyé !');
        }
