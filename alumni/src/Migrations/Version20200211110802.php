 ...
 */
final class Version20200211110802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, naãme VARCHAR(255) NOT NULL, etablishment VARCHAR(255) NOT NULL, year_start DATE NOT NULL, year_stop DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
