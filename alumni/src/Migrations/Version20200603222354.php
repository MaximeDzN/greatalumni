 ...
 */
final class Version20200603222354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reset_token VARCHAR(50) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL, CHANGE expression expression VARCHAR(255) DEFAULT NULL');
